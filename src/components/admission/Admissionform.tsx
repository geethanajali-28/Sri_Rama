...
const inputCls =
  "w-full border border-slate-300 rounded-lg px-4 py-2.5 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition placeholder:text-slate-400 bg-white";

const selectCls =
  "w-full border border-slate-300 rounded-lg px-4 py-2.5 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition bg-white";
...
export default function ApplicationForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      {/* ── Header ── */}
      <div className="bg-gradient-to-r from-[#1a2356] via-[#1e3a8a] to-[#1a2356] py-10 px-4 text-center">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-8">
        ...
        <div className="relative mb-8">
          <div className="h-1.5 bg-slate-200 rounded-full">
            <div
              className="h-1.5 bg-gradient-to-r from-blue-600 to-blue-400 rounded-full transition-all duration-500"
        ...
        <div className="bg-white rounded-2xl shadow-md border border-slate-100 overflow-hidden mb-12">
          ...
          <div className="px-6 py-5 bg-slate-50 border-t border-slate-100 flex justify-between items-center">
            ...
            {step < steps.length - 1 ? (
              <button
                onClick={next}
                className="flex items-center gap-2 bg-[#1e3a8a] hover:bg-blue-800 text-white px-6 py-2.5 rounded-xl text-sm font-semibold transition shadow-md"
              >
                Next
        ...
        <div className="text-center pb-10 text-sm text-slate-500">
          ...
          {" · "}
          <a href="mailto:srfgck@gmail.com" className="text-blue-600 underline">
            srfgck@gmail.com
          </a>
        </div>
      </div>
