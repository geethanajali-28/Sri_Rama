...
export default function Eligibility() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      {/* ── Hero Banner ── */}
      <div className="relative overflow-hidden bg-gradient-to-r from-[#1a2356] via-[#1e3a8a] to-[#1a2356] py-16 px-4">
        {/* Decorative circles */}
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mt-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <a
                        ...
                        className="inline-flex items-center justify-center w-full gap-2 text-white font-semibold py-3 px-6 rounded-xl transition-opacity hover:opacity-90 shadow-md mt-2"
                        style={{ backgroundColor: course.accent }}
                      >
      ...
      <div className="bg-gradient-to-r from-[#1a2356] to-[#1e3a8a] py-12 px-4 text-center">
        ...
        <p className="text-blue-300 mb-6">Our team is ready to assist you through the process.</p>
